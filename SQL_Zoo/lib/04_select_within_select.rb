...
# [["Bahrain", "Middle East"], ["Bangladesh", "South Asia"], ["Benin", "Africa"], ["Bhutan", "South Asia"], ["Bolivia", "South America"], ["Botswana", "Africa"], ["Brazil", "South America"], ["Brunei", "Asia-Pacific"], ["Burkina Faso", "Africa"], ["Burma", "Asia-Pacific"], ["Burundi", "Africa"]]
...
def sparse_continents
  ...
  execute(<<-SQL)
  SELECT
      name, continent, population, MAX(population) AS bigly
    FROM
      countries
    WHERE
      continent IN (
